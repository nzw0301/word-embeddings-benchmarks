...
from .analogy import SimpleAnalogySolver
from .datasets.analogy import fetch_msr_analogy, fetch_google_analogy
from .datasets.analogy import fetch_semeval_2012_2
from .datasets.analogy import fetch_wordrep
